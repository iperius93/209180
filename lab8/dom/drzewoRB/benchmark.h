...
class Benchmark
{
	...
	*/
	...
	/*!
	 *	\brief Testuje drzewo czerwono-czarne i zapisuje wyniki do pliku wynikow.

		\param Testowe - wskaznik na obiektu typu drzewoRB, tetsowany obiekt
		\param powtorzenia - ilosc powtorzen testu
		\param ilosc_liczb - ile liczb wykorzystamy do testu
	*/
	void testuj(drzewoRB *Testowe, int powtorzenia, int ilosc_liczb);
